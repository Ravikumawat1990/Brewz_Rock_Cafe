...
public class ExpandableListAdapterCustomize extends BaseExpandableListAdapter implements View.OnClickListener {
    ...
    public ExpandableListAdapterCustomize(Context context, List<String> listDataHeader,
        ...
        viewHolderChild.radioButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (childText.getIsChecked().equals("0")) {
                    ...
                    ViewCustomize.listAdapter.notifyDataSetChanged();
                    ViewCustomize.expListView.invalidateViews();
