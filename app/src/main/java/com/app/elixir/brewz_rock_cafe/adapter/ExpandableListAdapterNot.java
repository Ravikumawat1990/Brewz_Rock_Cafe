            ...
            public void onClick(View v) {
                if (childText.getIsChecked().equals("0")) {
                    ...
                    try {
                        ...
                        viewActivity.textViewItemPrice.setText(CM.getSp(_context, "currency", "").toString() + String.valueOf(form.format(aFloat)));
                    } catch (Exception e) {
                    }
                    ...
                    viewActivity.expandableListAdapterNot.notifyDataSetChanged();
                    viewActivity.expListView1.invalidateViews();
